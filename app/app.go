...
import (
	...
	ibcdextypes "github.com/username/interchange/x/ibcdex/types"
	"github.com/username/interchange/x/interchange"
	interchangekeeper "github.com/username/interchange/x/interchange/keeper"
	interchangetypes "github.com/username/interchange/x/interchange/types"
)
...
func New(
	...
	app.InterchangeKeeper = *interchangekeeper.NewKeeper(
		appCodec,
		keys[interchangetypes.StoreKey],
		keys[interchangetypes.MemStoreKey],
	)
	interchangeModule := interchange.NewAppModule(appCodec, app.InterchangeKeeper)
