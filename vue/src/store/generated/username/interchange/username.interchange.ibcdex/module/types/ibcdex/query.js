...
export class QueryClientImpl {
    ...
    DenomTrace(request) {
        ...
        const promise = this.rpc.request('username.interchange.ibcdex.Query', 'DenomTrace', data);
    ...
    DenomTraceAll(request) {
        ...
        const promise = this.rpc.request('username.interchange.ibcdex.Query', 'DenomTraceAll', data);
    ...
    BuyOrderBook(request) {
        ...
        const promise = this.rpc.request('username.interchange.ibcdex.Query', 'BuyOrderBook', data);
    ...
    BuyOrderBookAll(request) {
        ...
        const promise = this.rpc.request('username.interchange.ibcdex.Query', 'BuyOrderBookAll', data);
    ...
    SellOrderBook(request) {
        ...
        const promise = this.rpc.request('username.interchange.ibcdex.Query', 'SellOrderBook', data);
    ...
    SellOrderBookAll(request) {
        ...
        const promise = this.rpc.request('username.interchange.ibcdex.Query', 'SellOrderBookAll', data);
