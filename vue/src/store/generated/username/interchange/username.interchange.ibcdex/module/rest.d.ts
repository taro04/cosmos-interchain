...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    }, params?: RequestParams) => Promise<HttpResponse<IbcdexQueryAllBuyOrderBookResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
    ...
    querySellOrderBookAll: (query?: {
        ...
        "pagination.limit"?: string;
        "pagination.countTotal"?: boolean;
    }, params?: RequestParams) => Promise<HttpResponse<IbcdexQueryAllSellOrderBookResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    querySellOrderBook: (index: string, params?: RequestParams) => Promise<HttpResponse<IbcdexQueryGetSellOrderBookResponse, RpcStatus>>;
}
export {};
